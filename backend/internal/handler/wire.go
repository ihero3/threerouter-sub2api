...
func ProvideAdminHandlers(
	...
	governanceHandler *admin.GovernanceHandler,
...
func ProvideGatewayHandler(
	...
	h := NewGatewayHandler(gatewayService, openAIGatewayService, geminiCompatService, antigravityGatewayService,
		...
		errorPassthroughService, contentModerationService, userMsgQueueService, cfg, settingService, complianceService)
...
func ProvideOpenAIGatewayHandler(
	...
	h := NewOpenAIGatewayHandler(gatewayService, concurrencyService, billingCacheService, apiKeyService,
		usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, cfg, complianceService)
	h.securityAuditCoordinator = coordinator
...
func ProvideHandlers(
	...
	registrationClickCaptchaHandler *RegistrationClickCaptchaHandler,
	...
	governanceUserHandler *GovernanceUserHandler,
	teamHandler *TeamHandler,
	departmentHandler *DepartmentHandler,
	consumerHandler *ConsumerHandler,
	teamAnalyticsHandler *TeamAnalyticsHandler,
	modelPlazaHandler *ModelPlazaHandler,
	asyncImageHandler *AsyncImageHandler,
	batchImageHandler *BatchImageHandler,
	videoGatewayHandler *VideoGatewayHandler,
	mediaGatewayHandler *MediaGatewayHandler,
...
var ProviderSet = wire.NewSet(
	// Top-level handlers
	NewAuthHandler,
	NewRegistrationClickCaptchaHandler,
	NewUserHandler,
	NewAPIKeyHandler,
	NewUsageHandler,
	NewRedeemHandler,
	...
	NewTicketHandler,
	NewGovernanceUserHandler,
	NewTeamHandler,
	NewDepartmentHandler,
	NewConsumerHandler,
	NewTeamAnalyticsHandler,
	NewModelPlazaHandler,
	NewAsyncImageHandler,
	ProvideBatchImageHandler,
	NewVideoGatewayHandler,
	NewMediaGatewayHandler,
