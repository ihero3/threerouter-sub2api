...
func (_c *TicketCreate) SetContact(v string) *TicketCreate {
...
func (_c *TicketCreate) check() error {
	if _, ok := _c.mutation.Contact(); !ok {
		return &ValidationError{Name: "contact", err: errors.New(`ent: missing required field "Ticket.contact"`)}
	}
	if v, ok := _c.mutation.Contact(); ok {
		if err := ticket.ContactValidator(v); err != nil {
			return &ValidationError{Name: "contact", err: fmt.Errorf(`ent: validator failed for field "Ticket.contact": %w`, err)}
		}
	}
...
func (_c *TicketCreate) createSpec() (*Ticket, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.Contact(); ok {
		_spec.SetField(ticket.FieldContact, field.TypeString, value)
		_node.Contact = value
	}
...
// SetContact sets the "contact" field.
func (u *TicketUpsert) SetContact(v string) *TicketUpsert {
	u.Set(ticket.FieldContact, v)
	return u
}

// UpdateContact sets the "contact" field to the value that was provided on create.
func (u *TicketUpsert) UpdateContact() *TicketUpsert {
	u.SetExcluded(ticket.FieldContact)
	return u
}
...
// SetContact sets the "contact" field.
func (u *TicketUpsertOne) SetContact(v string) *TicketUpsertOne {
	return u.Update(func(s *TicketUpsert) {
		s.SetContact(v)
	})
}
...
// UpdateContact sets the "contact" field to the value that was provided on create.
func (u *TicketUpsertOne) UpdateContact() *TicketUpsertOne {
	return u.Update(func(s *TicketUpsert) {
		s.UpdateContact()
	})
}
...
// SetContact sets the "contact" field.
func (u *TicketUpsertBulk) SetContact(v string) *TicketUpsertBulk {
	return u.Update(func(s *TicketUpsert) {
		s.SetContact(v)
	})
}
...
// UpdateContact sets the "contact" field to the value that was provided on create.
func (u *TicketUpsertBulk) UpdateContact() *TicketUpsertBulk {
	return u.Update(func(s *TicketUpsert) {
		s.UpdateContact()
	})
}
