...
type TicketQuery struct {
	...
	withUser     *UserQuery
	withMessages *TicketMessageQuery
...
func (_q *TicketQuery) QueryUser() *UserQuery {
...
func (_q *TicketQuery) QueryMessages() *TicketMessageQuery {
...
func (_q *TicketQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *TicketQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *TicketQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *TicketQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *TicketQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *TicketQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *TicketQuery) WithUser(opts ...func(*UserQuery)) *TicketQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *TicketQuery) WithMessages(opts ...func(*TicketMessageQuery)) *TicketQuery {
	query := (&TicketMessageClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TicketQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Ticket, error) {
	...
	if query := _q.withMessages; query != nil {
		if err := _q.loadMessages(ctx, query, nodes,
			func(n *Ticket) { n.Edges.Messages = []*TicketMessage{} },
			func(n *Ticket, e *TicketMessage) { n.Edges.Messages = append(n.Edges.Messages, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TicketQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Ticket, init func(*Ticket), assign func(*Ticket, *User)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Ticket)
	for i := range nodes {
...
func (_q *TicketQuery) loadMessages(ctx context.Context, query *TicketMessageQuery, nodes []*Ticket, init func(*Ticket), assign func(*Ticket, *TicketMessage)) error {
	...
	query.Where(predicate.TicketMessage(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(ticket.MessagesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *TicketQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUser != nil {
			_spec.Node.AddColumnOnce(ticket.FieldUserID)
		}
	}
