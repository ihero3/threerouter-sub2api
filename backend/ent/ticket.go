...
type Ticket struct {
	...
	// 分类: account, billing, api, model, other
	Category string `json:"category,omitempty"`
	// 优先级: low, normal, high, urgent
	Priority string `json:"priority,omitempty"`
	// 状态: open, pending, answered, closed
...
func (*Ticket) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case ticket.FieldContact, ticket.FieldTitle, ticket.FieldCategory, ticket.FieldPriority, ticket.FieldStatus:
