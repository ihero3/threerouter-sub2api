...
func (_u *TicketUpdate) SetContact(v string) *TicketUpdate {
	_u.mutation.SetContact(v)
	return _u
}

// SetNillableContact sets the "contact" field if the given value is not nil.
func (_u *TicketUpdate) SetNillableContact(v *string) *TicketUpdate {
	if v != nil {
		_u.SetContact(*v)
	}
	return _u
...
// SetContact sets the "contact" field.
func (_u *TicketUpdateOne) SetContact(v string) *TicketUpdateOne {
	_u.mutation.SetContact(v)
	return _u
}

// SetNillableContact sets the "contact" field if the given value is not nil.
func (_u *TicketUpdateOne) SetNillableContact(v *string) *TicketUpdateOne {
	if v != nil {
		_u.SetContact(*v)
	}
	return _u
