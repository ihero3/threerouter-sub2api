export default {
  ...
  usage: {
    ...
    videoUnitPrice: 'Per-video price',
  ...
  affiliate: {
    ...
    tips: {
      ...
      registerReward: 'You also earn a $6 registration reward for every new user who signs up through your invite link (credited to your rebate quota immediately).'
    }
  },
