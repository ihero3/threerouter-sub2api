    ...
    h(
      ...
      [
        h('path', {
          'stroke-linecap': 'round',
          'stroke-linejoin': 'round',
          d: 'M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.331 0 4.467.89 6.067 2.343m0-12.301A8.966 8.966 0 0118 3.75c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.343m0-12.301v14.301'
        })
      ]
    )
}
...
//
// 条目顺序：密钥 → 用量 → 团队管理 → 可用渠道 → 渠道状态 → 订阅/支付 → 兑换/资料。
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/admin/models', label: t('nav.models'), icon: BoxIcon },
    { path: '/available-channels', label: t('nav.availableChannels'), icon: ChannelIcon, hideInSimpleMode: true, featureFlag: flagAvailableChannels },
    { path: '/monitor', label: t('nav.channelStatus'), icon: SignalIcon, featureFlag: flagChannelMonitor },
    { path: '/support/tickets', label: t('nav.tickets'), icon: TicketIcon, hideInSimpleMode: true },
    {
      path: '/team',
      ...
      expandOnly: true,
      children: [
        { path: '/team/departments', label: t('nav.departments'), icon: FolderIcon },
        { path: '/team/consumers', label: t('nav.consumers'), icon: UserIcon },
        { path: '/team/analytics', label: t('nav.teamAnalytics'), icon: ChartIcon },
        { path: '/team/settings', label: t('nav.teamSettings'), icon: CogIcon },
      ],
    },
    ...
    { path: '/governance', label: t('nav.governance'), icon: ShieldIcon },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/blogs', label: t('nav.blog'), icon: BlogIcon },
    { path: '/admin/proxies', label: t('nav.proxies'), icon: ServerIcon },
    { path: '/admin/risk-control', label: t('nav.riskControl'), icon: ShieldIcon, hideInSimpleMode: true, featureFlag: flagRiskControl },
    { path: '/admin/governance', label: t('nav.governance'), icon: ShieldIcon, hideInSimpleMode: true },
    {
    ...
    { path: '/admin/promo-codes', label: t('nav.promoCodes'), icon: GiftIcon, hideInSimpleMode: true },
    {
      ...
      children: [
        ...
        { path: '/admin/affiliates/relations', label: t('nav.affiliateRelations'), icon: UsersIcon },
